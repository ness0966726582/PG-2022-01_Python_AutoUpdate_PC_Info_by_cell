...
nasPath_for_googleKey = ["\\\\10.231.199.10\\Temp\\.AutoKey-ness\\creds.json"]
...
def all_Auto_GSeet_List():
    ...
    creds = ServiceAccountCredentials.from_json_keyfile_name(nasPath_for_googleKey[0], scope) #權限金鑰
